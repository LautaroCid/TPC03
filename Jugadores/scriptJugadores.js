...
zoo.agregarAnimal("Fábio1","G", 43, 1.88, 86, "Brasil");
zoo.agregarAnimal("Marlon4", "D", 28, 1.83, 78, "Brasil");
zoo.agregarAnimal("Marcelo12", "D", 35, 1.73, 72, "Brasil");
zoo.agregarAnimal("Nino33", "D", 26, 1.88, 82, "Brasil");
zoo.agregarAnimal("John Kennedy9", "A", 21, 1.73, 71, "Brasil");
zoo.agregarAnimal("Keno11", "A", 34, 1.78, 72, "Brasil");
zoo.agregarAnimal("Germán Cano14", "A", 35, 1.78, 81, "Argentina");
